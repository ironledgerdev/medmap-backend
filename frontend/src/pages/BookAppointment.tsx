  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      try {
         ...
         // This will automatically redirect to PayFast
         await PaymentsRepo.initiateBookingPayment(booking.id, bookingFee);
         // If we reach here, the form submission didn't work - fallback
         toast({
             title: "Success",
             description: "Booking created! Redirecting to payment...",
         });
      } catch (payError) {
         ...
         // Still navigate to bookings page
